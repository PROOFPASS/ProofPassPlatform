...
echo "[INFO] Initializing OpenBao for ProofPass..."
...
echo "[INFO] Creating ProofPass application policy..."
...
echo ""
echo "[SUCCESS] OpenBao initialization complete!"
echo ""
